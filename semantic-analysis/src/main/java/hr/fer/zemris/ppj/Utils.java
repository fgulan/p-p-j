...
public class Utils {
     ...
     * 
     * @param node node that was naughty
     ...
     * 
     * @param table local scope table (GLOBAL_SCOPE can be passed here as well, we don't judge)
     * @param name function name (don't pass nulls here)
     * @param arguments should be resolved peacefully
     * @param returnType it does what it says on the tin, really
     * @return true if function was added to the scope table or if you like redundancy, false otherwise
     */
    public static boolean handleFunction(IdentifierTable table, String name, 
