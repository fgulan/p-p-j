...
public class DFAConverterTest {
	...
	public void test() {
        ...
        ENFAutomaton source = new ENFAutomaton(states, acceptStates, inputs, function, state1);
        converter = new DFAConverter();
        DFAutomaton newDFA = converter.transform(source);
        ...
        for (final Transition trans : transitionsDFA) System.out.println(trans);
